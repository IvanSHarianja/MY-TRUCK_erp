...
class AssetMaintenanceLogPolicy
{
    ...
    public function view(User $user, AssetMaintenanceLog $log): bool { return $this->checkTenantAccess($user); }
    public function create(User $user): bool { return $this->check($user, Permission::OperationalManage); }
    public function update(User $user, AssetMaintenanceLog $log): bool { return $this->check($user, Permission::OperationalManage); }
    public function delete(User $user, AssetMaintenanceLog $log): bool { return $this->check($user, Permission::OperationalManage); }
